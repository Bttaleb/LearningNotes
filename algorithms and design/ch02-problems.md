...
(i) a natural [[ch02-fundamental-analysis-algo-efficiency#Measuring an inputs size|size metric]] for its inputs
(ii) its basic operations
(iii) if basic operation count can be different for inputs of the same size:
