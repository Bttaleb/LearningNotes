...
%10.3e -> displays x im econential form, using 10 characters overall, with 3 digits after the decimal point. X requires 9 characters altogether (including the exponent), so 1 space precedes x
%10.
